                    ...
                    >
                        <Link href="/checkout">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="relative inline-flex items-center justify-center px-10 py-5 font-bold text-blue-900 
                        ...
                        <a href="#como-funciona">
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="inline-flex items-center justify-center px-10 py-5 font-bold text-white 
