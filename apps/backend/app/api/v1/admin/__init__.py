...
from .dicas import router as dicas_router
...
router.include_router(dicas_router, prefix="/dicas-ia", tags=["Admin Dicas IA"])
...
router.include_router(vendas_router, prefix="/vendas", tags=["Admin Vendas"])
